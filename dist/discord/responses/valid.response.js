...
const getDefaultEmbed = (status, wl, list = {}) => {
    ...
    const embed = new discord_js_1.MessageEmbed()
        ...
        .setURL(`${process.env.ITEM_URL}${itemID}`)
        .setThumbnail(`${process.env.THUMBNAIL_URL}${itemID}.png`)
        .addFields({ name: 'Action', value: `**${status}**` }, { name: 'Price Threshold', value: threshold.toLocaleString('en-US') + ' z' }, {
